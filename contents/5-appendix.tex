\anonsection{Приложение А. Исходные коды} \label{sec:appendix}

\lstinputlisting[caption=\texttt{collect.pl}, label=app:collect]{data/sca-playground/strcmp-attack/collect.pl}

\lstinputlisting[caption=\texttt{vulnerable.c}, label=app:vuln]{data/sca-playground/strcmp-attack/vulnerable.c}

\lstinputlisting[caption=\texttt{timestamp.c}, label=app:timestamp]{data/sca-playground/strcmp-attack/timestamp.c}
