...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.45\textwidth]{data/sca-playground.wiki/strcmp_Timing_Attack/attempt-2/plots/int-to-5-init-non-outliers.png}
%         \includegraphics[width=0.45\textwidth]{data/sca-playground.wiki/strcmp_Timing_Attack/attempt-2/plots/ext-to-5-init.png}
%     \end{figure}
% \end{frame}
